...
**The game is not ours.** *Konami's Golf* was published by **Konami** for the MSX in 1985;
its catalogue number is **RC-723** and it is 16 KB. All rights over the game
...
The file `src/golf.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *Konami's Golf* or hold rights over the game, and you would rather this
